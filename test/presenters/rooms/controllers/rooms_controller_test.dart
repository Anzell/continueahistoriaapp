...
@GenerateMocks([GetPlayerRoomsUsecase])
void main(){
  ...
  setUp((){
    ...
    roomsController = RoomsController(getPlayerRoomsUsecase: mockGetPlayerRoomsUsecase, getRoomsByPlayerIdConverter: GetRoomsByPlayerIdConverter());
  });

  group("get rooms by player id", () {
    test("should return and set a valid rooms list of a player provided", () async {
      final expected = [
        ResumedGameRoom(id: "validId1", phrasesNumber: 10, playersNumber: 2, title: "Era uma vez")
      ];
